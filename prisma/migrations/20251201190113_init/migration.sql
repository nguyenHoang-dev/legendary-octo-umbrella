...
CREATE TABLE "TaiKhoan" (
    ...
    "anh" TEXT NOT NULL,
    "vai_tro" "Role" NOT NULL DEFAULT 'Student',
...
-- AddForeignKey
ALTER TABLE "SinhVien" ADD CONSTRAINT "SinhVien_id_lop_fkey" FOREIGN KEY ("id_lop") REFERENCES "Lop"("id_lop") ON DELETE RESTRICT ON UPDATE CASCADE;
